...
if [[ "$DISTRO" =~ ^(opensuse-tumbleweed|opensuse-leap|opensuse)$ ]]; then
  ...
  flatpak install flathub app.zen_browser.zen md.obsidian.Obsidian io.dbeaver.DBeaverCommunity com.github.iwalton3.jellyfin-media-player im.riot.Riot
...
pnpm install -g opencode-ai @fission-ai/openspec@latest nicobailon/pi-mcp-adapter nicobailon/pi-subagents nicobailon/pi-web-access
